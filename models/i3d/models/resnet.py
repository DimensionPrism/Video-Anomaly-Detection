...
if __name__=='__main__':
    net = i3_res50_nl(400)
    image = cv2.imread("/home/stark/Video-Anomaly-Detection/models/i3d/data/custom_dataset/training/frames/Normal_Videos_704_x264/0.jpg")
    # image = image.resize(image, (224, 224), interpolation=cv2.INTER_NEAREST)
    # image = torch.FloatTensor(image)

    inp = {'frames': torch.rand(1, 3, 16, 224, 224)}
    pdb.set_trace()
    pred, losses = net(inp)