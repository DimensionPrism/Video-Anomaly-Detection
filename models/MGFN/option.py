...
def parse_args():
    ...
    parser.add_argument('--test-rgb-list', default='datasets/UCF-Crime/ucf-i3d-test.list', help='list of test rgb features ')
    parser.add_argument('--gt', default='datasets/UCF-Crime/gt-ucf.npy', help='file of ground truth ')
