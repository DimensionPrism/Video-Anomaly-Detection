...
def compute_calibration_parameters(args, root):
    ...
    train_poses = np.load(os.path.join('./data/extracted_features', args.dataset_name, 'train', 'pose.npy'), allow_pickle=True)
    train_deep_features = np.load(os.path.join('./data/extracted_features', args.dataset_name, 'train', 'deep_features.npy'), allow_pickle=True)
    ...
    np.save('./data/extracted_features/{}/train_pose_scores.npy'.format(args.dataset_name), pose_scores)
    np.save('./data/extracted_features/{}/train_deep_features_scores.npy'.format(args.dataset_name), features_scores)
