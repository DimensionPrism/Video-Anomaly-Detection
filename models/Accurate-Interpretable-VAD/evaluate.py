...
from model.video_dataset import VideoDatasetWithFlows
...
def evaluate(args, root):
    ...
    train_velocity = np.load('./data/extracted_features/{}/train/velocity.npy'.format(args.dataset_name), allow_pickle=True)
    train_velocity = np.concatenate(train_velocity, 0)
    train_deep_features = np.load('./data/extracted_features/{}/train/deep_features.npy'.format(args.dataset_name), allow_pickle=True)
    train_deep_features = np.concatenate(train_deep_features, 0)

    train_pose = np.load('./data/extracted_features/{}/train/pose.npy'.format(args.dataset_name), allow_pickle=True)
    ...
    test_velocity = np.load('./data/extracted_features/{}/test/velocity.npy'.format(args.dataset_name), allow_pickle=True)
    test_pose = np.load('./data/extracted_features/{}/test/pose.npy'.format(args.dataset_name), allow_pickle=True)
    test_deep_features = np.load('./data/extracted_features/{}/test/deep_features.npy'.format(args.dataset_name), allow_pickle=True)
    ...
    train_pose_scores = np.load('./data/extracted_features/{}/train_pose_scores.npy'.format(args.dataset_name))
    train_deep_features_scores = np.load('./data/extracted_features/{}/train_deep_features_scores.npy'.format(args.dataset_name))
